...
//import 'package:altraport/screens/forgot_password.dart';
...
class _SignInPageState extends State<SignInPage> {
  ...
  String getMessageFromErrorCode(String errorCode) {
    ...
    if (_pwdcontroller.text.length == 0) return "Enter valid Password";
    else
                    ...
                    children: [
                      ...
                      AnimatedSwitcher(
                        ...
                        child: colorbutton(buttonText, () async {
                          if(_pwdcontroller.text.length==0) _showMyDialog("Enter valid Email/Password Combination");
